...
<table style="width:100%; border-collapse:collapse; border-spacing:0 18px; border:none; background:none;">
  ...
  />
    ...
    <strong><u>Qianchi Zhang</u></strong>, Hainan Zhang<sup>†</sup>, Liang Pang, Hongwei Zheng, and Zhiming Zheng.
      ...
      <div class="fs-14 lh-15" style="margin-top:3px;"><i class="fa fa-bank"></i>  <strong> ACL 2026 Main, AR=18.9% </strong> ｜ <span style="color:#C62828; font-weight:600;">CCF A</span> ｜ <a  href="./images/poster/Stable-RAG.pdf" target="_blank"><i class="fa fa-picture-o"></i> Poster</a>
        </div>
    </td>
  </tr>
</table>
